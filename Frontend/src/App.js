    ...
    <div className="App">
        ...
        <div className='btn-group' style={{ marginLeft: 10}}>
          ...
          <ButtonGroup style={Style}  variant="outlined" aria-label="outlined button group">
            <Button style={{width:"130px",color:'white' }} onClick={handleAddOpen}>ADD</Button>
            <Button style={{width:"130px", borderColor:"black" , margin:"0px 5px",color:'white' }} onClick={handleEditOpen}>EDIT</Button>
            <Button style={{width:"130px",color:'white' ,color:'white' }} onClick={handleDeleteOpen}>DELETE</Button>
          </ButtonGroup>
